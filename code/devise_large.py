...
if __name__ == "__main__":
    ...
    train_model(model, imtrain, desctrain, labelstrain, imval, descval, labelsval, BATCH, int(args.epochs), args.description)
    if args.savemodel == "y":
        with open(args.description + ".pickle",'rb') as f:
            pickle.dump(model, f)
